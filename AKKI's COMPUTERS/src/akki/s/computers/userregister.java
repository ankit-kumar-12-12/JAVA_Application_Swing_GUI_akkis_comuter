...
public class userregister extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(name.isEmpty() || uname.isEmpty() || email.isEmpty() || pno.isEmpty() || pass.isEmpty())
        {
            JOptionPane.showMessageDialog(null,"Please Enter ALL fileds");
        } 
        else if(pno.length()!=10)
        {
            JOptionPane.showMessageDialog(null,"Please Enter Correct Phone No.");
        }
        ...
        else
        {
            try
            {
                ...
                String qry="INSERT INTO `userinfo`(`name`, `uname`, `email`, `pno`, `pass`) VALUES (?,?,?,?,?)";
                ...
                JOptionPane.showMessageDialog(null,"Successfully Register Now Login");
